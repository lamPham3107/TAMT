...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', default='mini_imagenet', choices=['Rareact2','Rareact', 'k400','ucf101','hmdb51','SSv2Full','SSv2Small','tiered_imagenet', 'diving48'])
    parser.add_argument('--data_path', type=str, help='dataset path')

    parser.add_argument('--model', default='ResNet12', choices=['ResNet12', 'ResNet18', 'VideoMAENormal','VideoMAES','VitClip','VideoMAEB','VideoMAE'])
    ...
    parser.add_argument('--save_freq', default=30, type=int, help='the frequency of saving model .pth file')
